...
y_values = ["f(x) =", "g(x) =", "h(x)", "b(x)", "r(X)"]
equations = [" "]
right_symbols = ["÷", "×", "-", "+", "="]
top_symbols = ["AC", "+/-", "%"]
others = ["Graph", "f(x)", "sin(", "cos(", "tan(", "√", "log(", "ln("]

row_count = len(button_values) #2
...
def button_clicked(value):
    global right_symbols, top_symbols, label, A, B, operator, graph_values, y_values, equations, equations_column, equations_row
